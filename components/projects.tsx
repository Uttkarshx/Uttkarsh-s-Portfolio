...
const projectsData = [
  ...
  },
  {
    id: 2,
    title: "Chess Clock ",
    description: "An online chess clock using React js . A chess clock measures each player’s time during a game, ensuring fair play, precision, and adding intensity to every move.",
